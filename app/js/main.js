$(function(){
    ...
    $('.products__slider').slick({
        ...
        nextArrow: '<button class="slider-btn slide-btn__right"><svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0.78161 17L9 9L0.78161 1" /></svg></button>',
        infinite: false,
    });
